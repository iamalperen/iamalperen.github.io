...
let LoginComponent = class LoginComponent {
    constructor(toastr, auth, router, formBuilder) {
        this.toastr = toastr;
        this.auth = auth;
        this.router = router;
...
let PokemonDetailEffects = class PokemonDetailEffects {
    constructor(pokemonService, actions$) {
        this.pokemonService = pokemonService;
        this.actions$ = actions$;
        this.loadPokemonDetail$ = this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions__WEBPACK_IMPORTED_MODULE_3__["ActionTypes"].LOAD_POKEMON_DETAIL_REQUEST), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])((action) => this.pokemonService.getPokemonDetail(action.pokemonId)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((pokemon) => {
            return (new _actions__WEBPACK_IMPORTED_MODULE_3__["PokemonDetailLoadSuccessAction"]({ pokemon_detail: pokemon }));
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(error => Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["of"])(new _actions__WEBPACK_IMPORTED_MODULE_3__["PokemonDetailLoadFailureAction"](error))))));
    }
};
...
let PokemonDetailStoreModule = class PokemonDetailStoreModule {
};
...
/* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./actions */ "./src/app/root-store/pokemon-detail-store/actions.ts");
/* harmony import */ var _state__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./state */ "./src/app/root-store/pokemon-detail-store/state.ts");


function pokemonDetailReducer(state = _state__WEBPACK_IMPORTED_MODULE_1__["initialState"], action) {
    switch (action.type) {
        case _actions__WEBPACK_IMPORTED_MODULE_0__["ActionTypes"].LOAD_POKEMON_DETAIL_REQUEST: {
            return Object.assign({}, state, { isLoading: true, error: null });
        }
        case _actions__WEBPACK_IMPORTED_MODULE_0__["ActionTypes"].LOAD_POKEMON_DETAIL_SUCCESS: {
            return Object.assign({}, state, { pokemon_detail: action.payload.pokemon_detail, isLoading: false, error: null });
        }
        case _actions__WEBPACK_IMPORTED_MODULE_0__["ActionTypes"].LOAD_POKEMON_DETAIL_FAILURE: {
...
const getPokemonDetailState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createFeatureSelector"])('pokemon_detail');
const getError = (state) => state.error;
const getIsLoading = (state) => state.isLoading;
const getPokemonDetail = (state) => state.pokemon_detail;
const selectPokemonDetailError = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(getPokemonDetailState, getError);
const selectPokemonDetailIsLoading = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(getPokemonDetailState, getIsLoading);
const selectPokemonDetail = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(getPokemonDetailState, getPokemonDetail);
...
class PokemonListLoadRequestAction {
    constructor() {
        this.type = ActionTypes.LOAD_POKEMON_LIST_REQUEST;
    }
}
class PokemonListLoadFailureAction {
    constructor(payload) {
        this.payload = payload;
        this.type = ActionTypes.LOAD_POKEMON_LIST_FAILURE;
    }
}
class PokemonListLoadSuccessAction {
    constructor(payload) {
        this.payload = payload;
...
let PokemonListEffects = class PokemonListEffects {
    constructor(pokemonService, actions$) {
        this.pokemonService = pokemonService;
        this.actions$ = actions$;
        this.loadPokemonList$ = this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions__WEBPACK_IMPORTED_MODULE_3__["ActionTypes"].LOAD_POKEMON_LIST_REQUEST), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])((action) => this.pokemonService.getPokemonList()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(data => {
            const pokemon_list = data.results;
            return (new _actions__WEBPACK_IMPORTED_MODULE_3__["PokemonListLoadSuccessAction"]({ pokemon_list }));
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(error => Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["of"])(new _actions__WEBPACK_IMPORTED_MODULE_3__["PokemonListLoadFailureAction"](error))))));
    }
};
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["Effect"])(),
...
let PokemonListStoreModule = class PokemonListStoreModule {
};
...
/* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./actions */ "./src/app/root-store/pokemon-list-store/actions.ts");
/* harmony import */ var _state__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./state */ "./src/app/root-store/pokemon-list-store/state.ts");


function pokemonListReducer(state = _state__WEBPACK_IMPORTED_MODULE_1__["initialState"], action) {
    switch (action.type) {
        case _actions__WEBPACK_IMPORTED_MODULE_0__["ActionTypes"].LOAD_POKEMON_LIST_REQUEST: {
            return Object.assign({}, state, { isLoading: true, error: null });
        }
        case _actions__WEBPACK_IMPORTED_MODULE_0__["ActionTypes"].LOAD_POKEMON_LIST_SUCCESS: {
            return Object.assign({}, state, { pokemon_list: action.payload.pokemon_list, isLoading: false, error: null });
        }
        case _actions__WEBPACK_IMPORTED_MODULE_0__["ActionTypes"].LOAD_POKEMON_LIST_FAILURE: {
            return Object.assign({}, state, { isLoading: false, error: action.payload.error });
        }
        default: {
            return state;
...
const getPokemonListState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createFeatureSelector"])('pokemon_list');
const getError = (state) => state.error;
const getIsLoading = (state) => state.isLoading;
const getPokemonList = (state) => state.pokemon_list;
const selectPokemonListError = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(getPokemonListState, getError);
const selectPokemonListIsLoading = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(getPokemonListState, getIsLoading);
const selectPokemonList = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(getPokemonListState, getPokemonList);
